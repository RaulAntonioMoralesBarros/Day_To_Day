    ...
    <div class="main-content-container container-fluid px-4">
        ...
        <div class="page-header row no-gutters py-4">
            <div class="col-lg-8 col-sm-4 text-center text-sm-left mb-0">
                ...
                <a href="life_diary.html" style="color: #007bff;"><i class="material-icons">
                        keyboard_backspace
                    </i>Volver</a>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6 col-sm-6 text-left text-sm-left mb-0">
                                <small class="text-muted">Página nº 6</small>
                            </div>
                        ...
                        <form class="add-new-post">
                            <input class="form-control form-control-lg mb-3" type="text" value=""
                                placeholder="Mi primer dia en el Jardin Infantil">
                            <div id="editor-container" class="add-new-post__editor mb-1">
                                ...
                                exertion you off. Left did fond drew fat head poor jet pan
                                Conviction up partiality as delightful is discovered. Yet jennings resolved disposed
                                exertion you off. Left did fond drew fat head poor jet pan
                                Conviction up partiality as delightful is discovered. Yet jennings resolved disposed
                                exertion you off. Left did fond drew fat head poor jet pan
                    ...
                    <div class='card-body p-0'>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item px-3 pb-2">
                                ...
                                <input id="input" placeholder="21:19 07/03/2020" />
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="">
                            <textarea name="" id="" cols="30" rows="2" class="form-control mb-3"
                                style="min-height: 50px; margin-top: 0px; margin-bottom: 16px; height: 10px;">
                                            Arturo prat 107, Linares.
                                    </textarea>
                        </form>
                    </div>
                </div>
